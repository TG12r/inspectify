...
# Seguridad para producción: solo activar en producción
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DATABASE_NAME', 'inspectify'),
...
# LeadsPro Digital API Token
LEADSPRO_API_URL = os.getenv('LEADSPRO_API_URL', '')
